...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mar. 02 juin 2020 à 17:49
...
INSERT INTO `agences` (`id`, `number`, `city`, `nbAgent`, `photo`) VALUES
(1, 'AGAIX01', 'Aix', 3, 'aix.jpg'),
(2, 'AGPA01', 'Paris', 3, 'paris.jpg'),
(3, 'AGLY01', 'Lyon', 3, 'lyon.jpg'),
(4, 'AGBO01', 'Bordeaux', 3, 'bordeaux.jpg');
...
INSERT INTO `bien` (`id`, `categorie`, `title`, `prix`, `address`, `city`, `description`, `superficie`, `surfaceTerrain`, `dependance`, `photo`, `nbPiece`, `nbEtage`, `nbChambre`, `owner`, `status`) VALUES
(1, 'maison', 'Maison rose', 250000, 'rue du compas', 'Aix', 'très jolie maison plein pied avec vue sur la route', 90, 120, 0, 'maison1.jpg', 5, 0, 2, 'Mousseux', 'Vendu'),
(2, 'appartement', 't3', 250000, '35 rue de la terrasse', 'Lyon', 'très joli appartement, belle vue sur parc', 57, 57, 1, 'appartement1.jpg', 3, 2, 1, 'Jo', 'Vendu'),
(3, 'maison', 'espacia', 350000, '45 au bout de la rue', 'Paris', 'maison a plusieurs étages avec vue sur La Seine', 100, 120, 0, 'maison2.jpg', 6, 2, 3, 'Philipps', 'En vente'),
(4, 'appartement', 't2', 30000, '90 cours jean jaures', 'Bordeaux', 'petit appartement idéal pour des étudiants', 45, 45, 0, 'appartement2.jpg', 2, 3, 1, 'Bolduc', 'En vente'),
(5, 'appartement', 't3', 45000, '5 rue le corbusier', 'Aix', 'appartement proche de magasin', 67, 70, 1, 'appartement3.jpg', 3, 2, 2, 'Vongola', 'En vente'),
(6, 'maison', 'neuve', 350000, '32 rue des mocassins', 'Bordeaux', 'maison avec vaste jardin', 110, 200, 2, 'maison3.jpg', 6, 1, 3, 'Jumel', 'Vendu'),
(7, 'maison', 'serenity', 340000, '23 rue du bonheur', 'Lyon', 'maison familiale a la sortie de la ville', 95, 130, 1, 'maison4.jpg', 5, 0, 4, 'Apid', 'En vente'),
(8, 'appartement', 't4', 150000, '15 saint Honore', 'Paris', 'très bel appartement avec une vue sur la tour Eiffel', 75, 75, 0, 'appartement4.jpg', 4, 2, 3, 'Roche', 'Vendu');
...
(1, 'mousseuxpj', 'azerty', 'Mousseux', 'Pierre-jean', 'homme', '1957-12-03', 352415195, 'pj.mousse@gmail.com', '2 rue de la paix', 'Aix', 'fr', 3),
